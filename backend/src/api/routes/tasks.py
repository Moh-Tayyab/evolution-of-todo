...
async def list_tasks(
    ...
    # Convert to dicts to avoid lazy-loading tags in async mode
    return [
        {
            "id": task.id,
...
async def create_task(
    ...
    # Return dict to avoid lazy-loading tags relationship in async mode
    return {
        "id": task.id,
        "user_id": task.user_id,
        "title": task.title,
        ...
        "priority": task.priority,
        "completed": task.completed,
        "tags": [],  # Don't lazy-load tags in async mode
        "created_at": task.created_at.isoformat(),
        "updated_at": task.updated_at.isoformat(),
    }
...
async def get_task(
    ...
    # Return dict to avoid lazy-loading tags
    return {
        "id": task.id,
        "user_id": task.user_id,
        "title": task.title,
