...
## Animation Conventions (Phase III)
...
- **Variants**: `src/lib/animations/variants.ts`
- **Easings**: `src/lib/animations/easing.ts`
- **Hooks**: `src/lib/animations/hooks.ts`
- **GSAP provider**: `src/lib/animations/gsap-provider.tsx`

### Performance Guidelines

1. Use `transform` and `opacity` only (avoid animating width/height)
2. Limit simultaneous animations to 3-5 elements
