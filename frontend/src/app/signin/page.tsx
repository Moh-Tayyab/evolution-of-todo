...
export default function SignInPage() {
  ...
  return (
    ...
    >
      {/* Brand Side */}
      <motion.div
        className="hidden lg:flex w-1/2 bg-gradient-to-br from-indigo-500 to-purple-700 items-center justify-center p-12 relative overflow-hidden"
      ...
      >
        ...
        {!prefersReducedMotion && (
          <>
            ...
            />
            <motion.div
              className="absolute bottom-20 left-20 w-48 h-48 bg-purple-300 rounded-full mix-blend-overlay filter blur-3xl"
              animate={{
                x: [0, -20, 0],
                y: [0, 20, 0],
                scale: [1, 1.2, 1],
