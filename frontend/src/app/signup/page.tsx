...
// Premium Sign up page with luxury glass morphism design

"use client";

import Link from "next/link";
import { motion, useReducedMotion } from "framer-motion";
import { Target, Sparkles, Zap, Shield, ArrowRight } from "lucide-react";
...
export default function SignUpPage() {
  ...
  return (
    <motion.div
      className="min-h-screen flex relative overflow-hidden bg-gradient-to-br from-slate-50 via-pink-50 to-purple-50 dark:from-slate-950 dark:via-pink-950 dark:to-purple-950"
    ...
    >
      ...
      {/* Brand Side */}
      <motion.div
        className="hidden lg:flex w-1/2 bg-gradient-to-br from-fuchsia-600 via-pink-600 to-purple-600 items-center justify-center p-12 relative overflow-hidden"
      ...
      >
        ...
        {!prefersReducedMotion && (
          <>
            ...
            />
            <motion.div
              className="absolute bottom-32 left-32 w-56 h-56 bg-violet-300/20 rounded-full backdrop-blur-sm"
              animate={{
                x: [0, -30, 0],
                y: [0, 30, 0],
                scale: [1, 1.25, 1],
            ...
            />
            <motion.div
              className="absolute top-1/2 left-1/3 w-40 h-40 bg-pink-300/20 rounded-full backdrop-blur-sm"
              {...floatVariants}
            />
          </>
        )}
        ...
        >
          ...
          <motion.h1
            className="text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-pink-100 to-white bg-300% animate-gradient"
          ...
          >
            Create your account and experience premium task management with elegance.
          </motion.p>
          ...
          >
            {[
              { icon: Sparkles, text: "Beautiful premium design" },
              ...
              >
                <feature.icon className="w-5 h-5 text-pink-200" />
      ...
      >
        ...
        >
          ...
          {!prefersReducedMotion && (
            <motion.div
              className="absolute inset-0 rounded-3xl bg-gradient-to-r from-fuchsia-500 via-pink-500 to-purple-500 opacity-20 blur-xl"
              animate={{
          ...
          <div className="relative z-10 p-10">
            ...
            >
              {/* Floating icon */}
              <motion.div
                className="inline-flex p-3 rounded-2xl bg-gradient-to-br from-fuchsia-500 via-pink-500 to-purple-500 mb-6 shadow-premium-lg"
                {...floatVariants}
                transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
              >
              ...
              <motion.h2
                className="text-4xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-600 via-pink-600 to-purple-600 bg-300% animate-gradient"
                style={{ backgroundSize: "200% auto" }}
                animate={
                  !prefersReducedMotion
                    ? {
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                ...
                >
                  <Link
                    href="/signin"
                    className="text-transparent bg-gradient-to-r from-fuchsia-600 to-purple-600 bg-clip-text font-semibold hover:underline decoration-2 underline-offset-2 inline-flex items-center gap-1 group"
                  >
                    Sign in
