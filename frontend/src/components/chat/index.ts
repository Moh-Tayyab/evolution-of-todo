 ...
 *
 * @example OpenAI ChatKit (Recommended)
 * ```tsx
 * import { TodoChatKit } from "@/components/chat"
 *
 * export default function ChatPage() {
 *   return <TodoChatKit userId={user.id} />
 * }
 * ```
 *
 * @example Custom ChatWidget
 * ```tsx
...
// OpenAI ChatKit component (Official - Recommended)
export { TodoChatKit } from "./TodoChatKit"

// Legacy custom widget component (can be deprecated)
